...
export const Icon: React.FC<IconProps> = ({ name, className = 'w-6 h-6' }) => {
  ...
  const icons: { [key: string]: React.ReactElement } = {
    ...
    bookmark: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" d="M17.593 3.322c.1.128.2.27.2.428V21a.75.75 0 0 1-1.085.67L12 18.089l-4.708 3.583A.75.75 0 0 1 6 21V3.75c0-.158.1-.3.2-.428L12 3l5.593.322Z" />
      </svg>
    ),
    bookmarkSolid: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          <path fillRule="evenodd" d="M6.32 2.577a49.255 49.255 0 0 1 11.36 0c1.497.174 2.57 1.46 2.57 2.93V21a.75.75 0 0 1-1.085.67L12 18.089l-4.708 3.583A.75.75 0 0 1 6 21V5.507c0-1.47 1.073-2.756 2.57-2.93Z" clipRule="evenodd" />
      </svg>
    ),
    share: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
